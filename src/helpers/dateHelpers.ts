...
export const timestampToDateString = (timestamp: number, withTimezone: boolean = false): string => {
...
export const printableElapsedTime = (timestamp: number, now: number = Date.now()): string => {
